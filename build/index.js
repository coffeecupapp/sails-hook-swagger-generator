...
var swagger_doc_1 = __importDefault(require("./lib/swagger-doc"));
module.exports = function (sails) {
    ...
    return {
        ...
        initialize: function (next) {
            ...
            sails.after('ready', function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, swagger_doc_1.default)(sails, routes, this)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
